> [!IMPORTANT]
> **[view all experiment outputs here →](https://fswd-outputs.ufraan.dev/)**

### FSWD lab experiments

full ftack web development lab - experiment code and output screenshots.

### experiments

| # | Experiment | Files | Output |
|---|------------|-------|--------|
| 1 | HTML basics | [index.html](exp01/index.html) | [screenshot](output-viewer/output/exp1-01.png) |
| 2 | CSS styling | [index.html](exp02/index.html) · [styles.css](exp02/styles.css) | [ss 1](output-viewer/output/exp2-01.png) · [ss 2](output-viewer/output/exp2-02.png) |
| 3 | JS basics | [index.html](exp03/index.html) · [script.js](exp03/script.js) | [screenshot](output-viewer/output/exp3-01.png) |
| 4 | DOM manipulation | [index.html](exp04/index.html) | [ss 1](output-viewer/output/exp4-01.png) · [ss 2](output-viewer/output/exp4-02.png) · [ss 3](output-viewer/output/exp4-03.png) |
